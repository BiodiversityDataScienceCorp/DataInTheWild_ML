...
8.  Let's see if there is a significant relationship between bill length and bill depth. Perform the correct statistical analysis (1 point) and interpret the results. (5 points total)
    ...
    -   What is the equation of the line of best fit? Use both variable names and values from the statistical analysis. (1 point) ***Answer: bill_depth = -0.168\*bill_length + 23.5***
    -   What is the p-value? (1 point) ***Answer: p = 2.74e-9***
    -   Is there a significant relationship? (1 point) ***Answer: Highly significant***
    -   What should we do with the null hypothesis? (1 point) ***Answer: Reject***
...
```{r}
# Mean and standard deviation of flipper length
...
3.  What if we wanted our summary data in centimeters instead of millimeters? We can acheive this in 2 steps.
    ...
    ```{r}
    # Function for conversion of mm to cm
    ...
    ```{r}
    # Modify flipper length column + find mean and sd
    chinstrap_summary <- chinstrap %>% 
...
```{r}
# (1) Measures of central tendancy include mean, median, or mode
# (2) Measures of dispersion are standard dev *or* BOTH min and max
penguins %>% 
  group_by(island) %>% 
