...
```{r}
# Mean battery life and signal distance, by maker
...
-   **Alternative Hypothesis** (*H*~A~): There *is* a difference between the mean values of battery life for the two manufacturers
